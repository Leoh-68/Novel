...
NINARouter::group(['namespace' => 'Admin', 'prefix' => config('app.admin_prefix'), 'middleware' => \NINA\Middlewares\LoginAdmin::class], function () {
    ...
    NINARouter::group(['middleware' => \NINAPermission\Middlewares\PermissionAdmin::class], function () {
        ...
        NINARouter::get('/add-coin', 'ApiController@addCoin')->name('addCoin');
        ...
        NINARouter::get('/member/man', 'MemberController@index')->name('member');
        NINARouter::get('/member/add', 'MemberController@add')->name('member.add');
        NINARouter::post('/member/save', 'MemberController@save')->name('member.save');
        NINARouter::get('/member/edit/', 'MemberController@edit',['as' => 'member.edit']);
        NINARouter::get('/member/delete', 'MemberController@delete')->name('member.delete');
