...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y container-fluid">
        <div class="app-ecommerce" x-data="$store.changePassword">
            <form class="validation-form" novalidate=""  method="post" action="{{url('member.save')}}" enctype="multipart/form-data">
                            ...
                            <div class="card-body card-article">
                                <div class="row">                                    
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input type="text" class="form-control  text-sm" name="code" id="code" placeholder="Mã thành viên" value="{{oldvalue('code')??($item['code']??'')}}">
                                    </div>

                                    <div class="form-group col-4">
                                        <label class="form-label" for="coin">Số hoa :</label>
                                        <input type="text" class="form-control  text-sm" name="coin" id="coin" placeholder="Số hoa" value="{{oldvalue('coin')??($item['coin']??'')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
