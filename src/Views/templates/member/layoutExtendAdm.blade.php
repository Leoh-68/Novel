...
@section('content')
    @push('styles')
        ...
        <link rel="stylesheet" href="@asset('assets/admin/vendor/css/rtl/core.css?' . time())" />
        <link rel="stylesheet" href="@asset('assets/admin/vendor/css/rtl/theme-default.css?' . time())" />
        <link rel="stylesheet" href="@asset('assets/admin/confirm/confirm.css')">
        <link rel="stylesheet" href="@asset('assets/holdon/HoldOn.css?' . time())">
        <link rel="stylesheet" href="@asset('assets/admin/vendor/libs/perfect-scrollbar/perfect-scrollbar.css?' . time())" />
        <link rel="stylesheet" href="@asset('assets/admin/vendor/libs/typeahead-js/typeahead.css?' . time())" />
        <link rel="stylesheet" href="@asset('assets/admin/vendor/libs/select2/select2.css?' . time())" />
    ...
    */
        ...
        <script src="@asset('assets/admin/toastify/toastify.js')"></script>
        <script src="@asset('assets/admin/js/apps.js')"></script>
        <script src="@asset('assets/js/alpinejs.js')"></script>
