                                            ...
                                            @if (!empty($item['id_user']))
                                                <div class="comment-item-avatar text-center">
                                                    <div class="inline-block rounded-full overflow-hidden">
                                                        <img src="{{ assets_photo('user', '65x65x1', $item->getUser()->first()->avatar, 'thumbs') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            @else
                                                <div class="comment-replies-letter {{ $item['poster'] }}">
                                                    {{ Comment::subName($item['fullname']) }}
                                                </div>
                                            @endif
                                        ...
                                        @endif --}}
                                            ...
                                            @if ($rowReplies->isNotEmpty())
                                                ...
                                                <div class="comment-replies mt-3">
                                                    @component('member.comment.replies', ['params' => $rowReplies])
                                                    @endcomponent

                                                </div>
                                            @endif
                                            @component('member.comment.reply', [
                                                'params' => $item,
                                                'linkSave' => url(
